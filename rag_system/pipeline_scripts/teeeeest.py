...
USER_ID = '2bd87cee60a5430ca23c84ee80d81cfa' # ! => Open the Kotaemon app ... go on a random page... see the logs to retrieve the USER ID !
...
class IndexingPipelineShortCut(IndexPipeline):
    ...
    def handle_docs(self, docs, file_id, file_path, article_metadata) -> int:
        ...
        try:
            ...
            llm_metadatas = {'title':'test', 'author':'test'} # MOCK 

            # Reconcile OpenAlex metadata with LLM output
            metadatas = article_metadata # MOCK 

            # additional functional metadata:
            metadatas_json = article_metadata # MOCK
